...
- [x] Test coverage document created: `usermods/lorawled/tests/test_parser.md` with 30 test vectors
...
- Test file: `usermods/lorawled/tests/test_parser.md` — documents all test vectors, error table, and replay wrap test
