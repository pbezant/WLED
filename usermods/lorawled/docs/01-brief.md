...
| Constraint | Detail |
|---|---|
| No WLED core modifications | All changes stay in `usermods/lorawled/` except the DMX TX pin patch (minimal, guarded with `#ifndef`) |
...
7. Firmware compiles and flashes to Heltec V3 without error using the `heltec_lorawled` PlatformIO environment.
