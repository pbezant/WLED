...
Define the contract between the cloud platform (LNS + application server) and LoRa-DMX devices deployed across multiple venues. Covers device grouping, site-level broadcast commands, per-device addressing, and tenant isolation.
