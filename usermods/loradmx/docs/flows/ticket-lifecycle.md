...
└─────────────────────────────────────────────────────────────────────────────┘
  ...
  └──────┬───────┘
         ...
         ▼
  ┌──────────────────────────────────────────────────────────┐
  │  ARCHITECT  (Claude Opus — loradmx-architect.prompt.md)  │
  │                                                          │
  ...
  └──────────────────────────┬───────────────────────────────┘
                             ...
                             ▼
  ┌──────────────────────────────────────────────────────────┐
  │  CODER  (Claude Sonnet — loradmx-coder.prompt.md)        │
  │                                                          │
  │  1. Read ticket + all spec refs                          │
  │  2. Implement exactly what ticket describes              │
  │  3. Run: npm run build                                   │
  │  4. Run: pio run -e heltec_loradmx                       │
  ...
  └──────────────────────────┬───────────────────────────────┘
           ...
           │  Spec gap       ▼
           │         ┌──────────────────────────────────────────────────────────┐
           │         │  TESTER  (GPT Codex/o3 — loradmx-tester.prompt.md)      │
           │         │                                                          │
           │         │  1. Run static checks (grep for violations)             │
           │         │  2. Run: npm run build + npm test                       │
           │         │  3. Run: pio run -e heltec_loradmx + esp32dev           │
           ...
           │                                    ▼
           │         ┌──────────────────────────────────────────────────────────┐
           │         │  REVIEWER  (GPT Codex/o3 — loradmx-reviewer.prompt.md)  │
           │         │                                                          │
...
|------|-------------------|
| Architect | `> GitHub Copilot: Open Prompt` → `loradmx-architect` |
| Coder | `> GitHub Copilot: Open Prompt` → `loradmx-coder` |
| Tester | `> GitHub Copilot: Open Prompt` → `loradmx-tester` |
| Reviewer | `> GitHub Copilot: Open Prompt` → `loradmx-reviewer` |
...
| Implementation | Coder | `usermods/loradmx/*.h`, `*.cpp`, patches |
